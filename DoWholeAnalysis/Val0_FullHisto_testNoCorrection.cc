    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        if ((Channel == 91) && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            ...
            if (LTcut_tt && charge_Type && !tau3_IsoB && !tau4_IsoB && (Event != Event_Double[1][1])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz);
                Event_Double[1][1] = Event;
            }
            if (LTcut_tt && charge_Type && tau3_IsoB && !tau4_IsoB && (Event != Event_Double[2][1])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz);
                Event_Double[2][1] = Event;
            }
            if (LTcut_tt && charge_Type && !tau3_IsoB && tau4_IsoB && (Event != Event_Double[3][1])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz);
            ...
            if (LTcut_tt && charge_Type && tau3_IsoB && tau4_IsoB && (Event != Event_Double[0][1])) {
                ...
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz);
            ...
            if (LTcut_tt && SS && l3_tauIsoMVA2raw > value_looserTauIso && l4_tauIsoMVA2raw > value_looserTauIso) {
                ...
                fillTreeN(BG_Tree, Channel, 4, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz);
            }
        }
        // ****************************************************************************
        // ScaleUp TT
