...
int main(int argc, char** argv) {
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        //####################################################        LT cuts
        bool LTcut_tt = ((chanelType.compare("TT") == 0) ? l3Pt + l4Pt > float_LTCut : 1);
        bool LTcut_mt = ((chanelType.compare("MT") == 0) ? l3Pt + l4Pt > float_LTCut : 1);
        bool LTcut_et = ((chanelType.compare("ET") == 0) ? l3Pt + l4Pt > float_LTCut : 1);
        bool LTcut_em = ((chanelType.compare("EM") == 0) ? l3Pt + l4Pt > float_LTCut : 1);


        //####################################################        Lepton Isolation cuts
        float looseMu = ((chanelType.compare("MT") == 0) ? float_LepIso : 0.3);
        float looseEle = ((chanelType.compare("ET") == 0) ? float_LepIso : 0.3);
        float looseLep = ((chanelType.compare("EM") == 0) ? float_LepIso : 0.3);



        //        bool LTcut = l3Pt + l4Pt > 50;
        //        bool tau3_IsoB = l3_tauIsoMVA2raw > .5;
        //        bool tau4_IsoB = l4_tauIsoMVA2raw > .5;
        //####################################################        Loose Cut for Shape
        ...
        if ((Channel == 91) && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            ...
            if (SS && l3_tauIsoMVA2raw > value_looserTauIso && l4_tauIsoMVA2raw > value_looserTauIso) {
        ...
        if (Channel == 92 && l4Pt > CutOnTauPt && mu_Size == 2 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
            ...
            if (LTcut_et && charge_Type && !tau4_IsoB && (!l3_eleId_Loose || !(l3_eleIso < looseEle)) && (Event != Event_Double[1][2])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][2] = Event;
            }
            if (LTcut_et && charge_Type && !tau4_IsoB && (l3_eleId_Loose && l3_eleIso < looseEle) && (Event != Event_Double[2][2])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][2] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && (!l3_eleId_Loose || !(l3_eleIso < looseEle)) && (Event != Event_Double[3][2])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][2] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && (l3_eleId_Loose && (l3_eleIso < looseEle)) && (Event != Event_Double[0][2])) {
            ...
            //Shape of Reducible BG
            if (SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_eleIso < value_looserLepIso)) && (Event != Event_Double[4][2])) {
        ...
        if (Channel == 93 && l4Pt > CutOnTauPt && electron_Size == 0 && l4_tauRejEleL && l4_tauRejMu2T) {
            ...
            if (LTcut_mt && charge_Type && !tau4_IsoB && (!l3_muId_Loose || !(l3_muIso < looseMu)) && (Event != Event_Double[1][3])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][3] = Event;
            }
            if (LTcut_mt && charge_Type && !tau4_IsoB && (l3_muId_Loose && l3_muIso < looseMu) && (Event != Event_Double[2][3])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][3] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && (!l3_muId_Loose || !(l3_muIso < looseMu)) && (Event != Event_Double[3][3])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][3] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && (l3_muId_Loose && (l3_muIso < looseMu)) && (Event != Event_Double[0][3])) {
                plotFill("VisibleMass_lt_pp", VisibleMass, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            ...
            //Shape of Reducible BG
            if (SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_muIso < value_looserLepIso)) && (Event != Event_Double[4][3])) {
        ...
        if (Channel == 94) {
            ...
            //Shape of Reducible BG
            if (SS && ((l4_eleIso < value_looserLepIso)) && ((l3_muIso < value_looserLepIso)) && (Event != Event_Double[4][4])) {
        ...
        if (Channel == 96 && l4Pt > CutOnTauPt && electron_Size == 2 && l4_tauRejEleL && l4_tauRejMu2T) {
            ...
            if (LTcut_mt && charge_Type && !tau4_IsoB && (!l3_muId_Loose || !(l3_muIso < looseMu)) && (Event != Event_Double[1][6])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][6] = Event;
            }
            if (LTcut_mt && charge_Type && !tau4_IsoB && (l3_muId_Loose && l3_muIso < looseMu) && (Event != Event_Double[2][6])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][6] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && (!l3_muId_Loose || !(l3_muIso < looseMu)) && (Event != Event_Double[3][6])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][6] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && (l3_muId_Loose && (l3_muIso < looseMu)) && (Event != Event_Double[0][6])) {
                plotFill("VisibleMass_lt_pp", VisibleMass, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            ...
            //Shape of Reducible BG
            if (SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_muIso < value_looserLepIso)) && (Event != Event_Double[4][6])) {
        ...
        if (Channel == 97 && l4Pt > CutOnTauPt && mu_Size == 0 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
            ...
            if (LTcut_et && charge_Type && !tau4_IsoB && (!l3_eleId_Loose || !(l3_eleIso < looseEle)) && (Event != Event_Double[1][7])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][7] = Event;
            }
            if (LTcut_et && charge_Type && !tau4_IsoB && (l3_eleId_Loose && l3_eleIso < looseEle) && (Event != Event_Double[2][7])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][7] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && (!l3_eleId_Loose || !(l3_eleIso < looseEle)) && (Event != Event_Double[3][7])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][7] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && (l3_eleId_Loose && (l3_eleIso < looseEle)) && (Event != Event_Double[0][7])) {
                plotFill("VisibleMass_lt_pp", VisibleMass, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            ...
            //Shape of Reducible BG
            if (SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_eleIso < value_looserLepIso)) && (Event != Event_Double[4][7])) {
        ...
        if (Channel == 98) {
            ...
            //Shape of Reducible BG
            if (SS && ((l4_muIso < value_looserLepIso)) && ((l3_eleIso < value_looserLepIso)) && (Event != Event_Double[4][8])) {
