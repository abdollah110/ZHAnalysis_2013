    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        if ((Channel == 91) && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            ...
            if (LTcut_tt && charge_Type && !tau3_IsoB && !tau4_IsoB && (Event != Event_Double[1][1])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
                Event_Double[1][1] = Event;
            }
            if (LTcut_tt && charge_Type && tau3_IsoB && !tau4_IsoB && (Event != Event_Double[2][1])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
                Event_Double[2][1] = Event;
            }
            if (LTcut_tt && charge_Type && !tau3_IsoB && tau4_IsoB && (Event != Event_Double[3][1])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
            ...
            if (LTcut_tt && charge_Type && tau3_IsoB && tau4_IsoB && (Event != Event_Double[0][1])) {
                ...
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
            ...
            if (LTcut_tt && SS && l3_tauIsoMVA2raw > value_looserTauIso && l4_tauIsoMVA2raw > value_looserTauIso) {
                ...
                fillTreeN(BG_Tree, Channel, 4, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
            }
        }
        // ****************************************************************************
        // ScaleUp TT
        ...
        if (Channel == 93 && l4Pt > CutOnTauPt && electron_Size == 0 && l4_tauRejEleL && l4_tauRejMu2T) {
            ...
            if (LTcut_mt && charge_Type && tau4_Iso_ltau && (l3_muId_Tight && (l3_muIso < TightMu)) && (Event != Event_Double[0][3]) && mu_Size == 3) {
                ...
                plotFill("SVMass_mmmt_pp_NoCorrection", SVMass, pt_Bin, 0, pt_Bin);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
        ...
        if (Channel == 97 && l4Pt > CutOnTauPt && mu_Size == 0 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
            ...
            if (LTcut_et && charge_Type && tau4_Iso_ltau && (l3_eleId_Tight && (l3_eleIso < TightEle)) && (Event != Event_Double[0][7]) && electron_Size == 3) {
                ...
                plotFill("SVMass_eeet_pp_NoCorrection", SVMass, pt_Bin, 0, pt_Bin);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, Run, Lumi, Event, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta, met, metPhi, covMet11, covMet12, covMet21, covMet22, l3M, l3Px, l3Py, l3Pz, l4M, l4Px, l4Py, l4Pz, eff_Correction, pu_Weight);
