...
void Estim_BG(int trChannel, std::string etaType, std::string whichLepton1, std::string kindFR1, int fitType1, float scale1, std::string whichLepton2, std::string kindFR2, int fitType2, float scale2, TH2F * Chnl_estimate, TH2F* Chnl_event) {



    std::vector<float> * FitPar1 = new std::vector<float>(3);
    FitPar1->clear();
    FitPar1 = (Get_FitParameter(whichLepton1));
    std::vector<float> * FitPar2 = new std::vector<float>(3);
    FitPar2->clear();
    FitPar2 = (Get_FitParameter(whichLepton2));
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        if (myChannel == trChannel && check_eta) {
            //        Do Category 0
            if (mysubChannel == 0) {
                double FrateX = fitFunction(_l3pt, fitType1, FitPar1) * scale1;
                double FrateY = fitFunction(_l4pt, fitType2, FitPar2) * scale2;
            ...
            if (mysubChannel == 1) {
                double FrateX = .1;
                double FrateX = fitFunction(_l4pt, fitType2, FitPar2) * scale2;
...
void Val3_BGestimation_Main(TH2F * Chnl_estimate, TH2F* Chnl_event, float FRScale_tau, float FRScale_ele, float FRScale_mu, std::string outName) {
    ...
    //    float FRScale_tau = 1.0;
    //    float FRScale_ele = 1.0;
    //    float FRScale_mu = 1.0;
    if (FRvsJetandEta_Sys) {
        Estim_BG(1, "BB", "tauLoose_Jet_B", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(1, "BE", "tauLoose_Jet_B", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(1, "EB", "tauLoose_Jet_E", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(1, "EE", "tauLoose_Jet_E", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(5, "BB", "tauLoose_Jet_B", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(5, "BE", "tauLoose_Jet_B", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(5, "EB", "tauLoose_Jet_E", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(5, "EE", "tauLoose_Jet_E", "l3_CloseJetPt_", 1, FRScale_tau, "tauLoose_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(2, "B", "eleTight_Jet", "l3_CloseJetPt_", 1, FRScale_ele, "tauLoose_ltau_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(2, "E", "eleTight_Jet", "l3_CloseJetPt_", 1, FRScale_ele, "tauLoose_ltau_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(3, "B", "muTight_Jet", "l3_CloseJetPt_", 1, FRScale_mu, "tauLoose_ltau_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(3, "E", "muTight_Jet", "l3_CloseJetPt_", 1, FRScale_mu, "tauLoose_ltau_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(6, "B", "muTight_Jet", "l3_CloseJetPt_", 1, FRScale_mu, "tauLoose_ltau_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(6, "E", "muTight_Jet", "l3_CloseJetPt_", 1, FRScale_mu, "tauLoose_ltau_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(7, "B", "eleTight_Jet", "l3_CloseJetPt_", 1, FRScale_ele, "tauLoose_ltau_Jet_B", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(7, "E", "eleTight_Jet", "l3_CloseJetPt_", 1, FRScale_ele, "tauLoose_ltau_Jet_E", "l4_CloseJetPt_", 1, FRScale_tau, Chnl_estimate, Chnl_event);
        Estim_BG(4, "NoEta", "muLoose_Jet", "l3_CloseJetPt_", 1, FRScale_mu, "eleLoose_Jet", "l4_CloseJetPt_", 1, FRScale_ele, Chnl_estimate, Chnl_event);
        Estim_BG(8, "NoEta", "eleLoose_Jet", "l3_CloseJetPt_", 1, FRScale_ele, "muLoose_Jet", "l4_CloseJetPt_", 1, FRScale_mu, Chnl_estimate, Chnl_event);
    }


    PrintResults(Chnl_estimate, Chnl_event, outName);
}

void Systematics_0() {
    float ScaleUp_tau = 1.20;
    float ScaleDown_tau = 0.80;
    float ScaleUp_lep = 1.30;
    float ScaleDown_lep = 0.70;

    TH2F* Chnl_estimate = new TH2F("Chnl_estimate", "Chnl_estimate", 10, 0, 10, 10, 0, 10);
    TH2F* Chnl_event = new TH2F("Chnl_event", "Chnl_event", 10, 0, 10, 10, 0, 10);
    Val3_BGestimation_Main(Chnl_estimate, Chnl_event, 1.0, 1.0, 1.0, "Reducible_norm.root");

    Chnl_estimate = new TH2F("Chnl_estimate1", "Chnl_estimate1", 10, 0, 10, 10, 0, 10);
    Chnl_event = new TH2F("Chnl_event1", "Chnl_event1", 10, 0, 10, 10, 0, 10);
    Val3_BGestimation_Main(Chnl_estimate, Chnl_event, ScaleUp_tau, 1.0, 1.0, "Reducible_tauUp.root");

    Chnl_estimate = new TH2F("Chnl_estimate2", "Chnl_estimate2", 10, 0, 10, 10, 0, 10);
    Chnl_event = new TH2F("Chnl_event2", "Chnl_event2", 10, 0, 10, 10, 0, 10);
    Val3_BGestimation_Main(Chnl_estimate, Chnl_event, ScaleDown_tau, 1.0, 1.0, "Reducible_tauDown.root");

    Chnl_estimate = new TH2F("Chnl_estimate3", "Chnl_estimate3", 10, 0, 10, 10, 0, 10);
    Chnl_event = new TH2F("Chnl_event3", "Chnl_event3", 10, 0, 10, 10, 0, 10);
    Val3_BGestimation_Main(Chnl_estimate, Chnl_event, 1.0, ScaleUp_lep, ScaleUp_lep, "Reducible_lepUp.root");

    Chnl_estimate = new TH2F("Chnl_estimate4", "Chnl_estimate4", 10, 0, 10, 10, 0, 10);
    Chnl_event = new TH2F("Chnl_event4", "Chnl_event4", 10, 0, 10, 10, 0, 10);
    Val3_BGestimation_Main(Chnl_estimate, Chnl_event, 1.0, ScaleDown_lep, ScaleDown_lep, "Reducible_lepDown.root");
