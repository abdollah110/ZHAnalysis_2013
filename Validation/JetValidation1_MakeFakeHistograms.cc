...
int main(int argc, char** argv) {
    ...
    //Just each categori shoul dbe filled once
    int Event_Double[5][9];
    memset(Event_Double, 0, sizeof (Event_Double[0][0]) * 5 * 9);
    float Ev_double_tau = 0;
    float Ev_double_ele = 0;
    float Ev_double_mu = 0;
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        if ((Channel == 91) && charge_Type && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            //        if ((Channel == 91) && charge_Type && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt) {

            if (tau3_IsoB && tau4_IsoB && (Event != Event_Double[0][1])) {
                ...
                plotFill("VisibleMass_mmtt_pp", VisibleMass, pt_Bin, 0, pt_Bin);
                Event_Double[0][1] = Event;
            }
            if (!tau3_IsoB && !tau4_IsoB && (Event != Event_Double[1][1])) {
            ...
            if (!tau3_IsoB && tau4_IsoB && (Event != Event_Double[2][1])) {
            ...
            if (tau3_IsoB && !tau4_IsoB && (Event != Event_Double[3][1])) {
        ...
        if (Channel == 92 && charge_Type && l4Pt > CutOnTauPt && mu_Size == 2 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
        ...
        if (Channel == 93 && charge_Type && l4Pt > CutOnTauPt && electron_Size == 0 && l4_tauRejEleL && l4_tauRejMu2T) {
        ...
        if ((Channel == 95) && charge_Type && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            //        if ((Channel == 95) && charge_Type && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt) {


            if (tau3_IsoB && tau4_IsoB && (Event != Event_Double[0][5])) {
                plotFill("TauPtJetPt_pp", l3Pt / l3_CloseJetPt, 100, 0, 2);
                plotFill("TauPtJetPt_pp", l4Pt / l4_CloseJetPt, 100, 0, 2);
                plotFill("Ratio_RefJet_CorrectedJet_pp", l3_RefJetPt / l3_CloseJetPt, 100, 0, 2);
                plotFill("Ratio_RefJet_CorrectedJet_pp", l4_RefJetPt / l4_CloseJetPt, 100, 0, 2);
                plotFill("VisibleMass_eett_pp", VisibleMass, pt_Bin, 0, pt_Bin);
                Event_Double[0][5] = Event;
            }
            if (!tau3_IsoB && !tau4_IsoB && (Event != Event_Double[1][5])) {
                plotFill("TauPtJetPt_ff", l3Pt / l3_CloseJetPt, 100, 0, 2);
                plotFill("TauPtJetPt_ff", l4Pt / l4_CloseJetPt, 100, 0, 2);
                plotFill("Ratio_RefJet_CorrectedJet_ff", l3_RefJetPt / l3_CloseJetPt, 100, 0, 2);
                plotFill("Ratio_RefJet_CorrectedJet_ff", l4_RefJetPt / l4_CloseJetPt, 100, 0, 2);
            ...
            if (!tau3_IsoB && tau4_IsoB && (Event != Event_Double[2][5])) {
            ...
            if (tau3_IsoB && !tau4_IsoB && (Event != Event_Double[3][5])) {
        ...
        if (Channel == 96 && charge_Type && l4Pt > CutOnTauPt && electron_Size == 2 && l4_tauRejEleL && l4_tauRejMu2T) {
        ...
        if (Channel == 97 && charge_Type && l4Pt > CutOnTauPt && mu_Size == 0 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
        ...
        if ((Channel == 91 || Channel == 95) && (l3Charge * l4Charge > 0) && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL && Event != Ev_double_tau) {
            ...
            if (FR_Estimation) plotFill("FakeRate_TT_Tau_Pt_Before_Jet", l3_CloseJetPt, pt_Bin, 0, pt_Bin);
            if (FR_Estimation) plotFill("FakeRate_TT_Tau_Pt_Before_Jet", l4_CloseJetPt, pt_Bin, 0, pt_Bin);
            if (FR_Estimation && tau3_IsoB) plotFill("FakeRate_TT_Tau_Pt_After_Loose_Jet", l3_CloseJetPt, pt_Bin, 0, pt_Bin);
            if (FR_Estimation && tau4_IsoB) plotFill("FakeRate_TT_Tau_Pt_After_Loose_Jet", l4_CloseJetPt, pt_Bin, 0, pt_Bin);
        ...
        //####################################################
        //0 GeV Tau
        bool eleFR_denum_0 = ((Channel == 92 && electron_Size < 2) || (Channel == 97 && electron_Size < 4)) && (l3Charge * l4Charge > 0) && WZ_Rej_B(l3Pt, l3Px, l3Py, met, metPhi) && l4Pt > 0 && l4_tauRejEleMVA3T && l4_tauRejMu2L;
        ...
        bool muFR_denum_0 = ((Channel == 93 && mu_Size < 4) || (Channel == 96 && mu_Size < 2)) && (l3Charge * l4Charge > 0) && WZ_Rej_B(l3Pt, l3Px, l3Py, met, metPhi) && l4Pt > 0 && l4_tauRejEleL && l4_tauRejMu2T;
