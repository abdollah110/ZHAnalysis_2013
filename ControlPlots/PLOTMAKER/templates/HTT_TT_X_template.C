...
hin->SetBinError(1,hin->GetBinContent(1)*0.30);
hin->SetBinError(2,hin->GetBinContent(2)*0.30);
hin->SetBinError(3,hin->GetBinContent(3)*0.30);
hin->SetBinError(4,hin->GetBinContent(4)*0.30);
hin->SetBinError(5,hin->GetBinContent(5)*0.30);
hin->SetBinError(6,hin->GetBinContent(6)*0.30);
hin->SetBinError(7,hin->GetBinContent(7)*0.30);
hin->SetBinError(8,hin->GetBinContent(8)*0.30);
hin->SetBinError(9,hin->GetBinContent(9)*0.30);
hin->SetBinError(10,hin->GetBinContent(10)*0.30);
hin->SetBinError(11,hin->GetBinContent(11)*0.30);
hin->SetBinError(12,hin->GetBinContent(12)*0.30);
hin->SetBinError(13,hin->GetBinContent(13)*0.30);
hin->SetBinError(14,hin->GetBinContent(14)*0.30);
hin->SetBinError(15,hin->GetBinContent(15)*0.30);
