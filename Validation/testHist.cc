...
void M_FR(int WP, std::string type, std::string files, std::string num, std::string denum, TH2F * hist2D_lep, Double_t fMin, Double_t fMax) {
    ...
    TGraph_FR->GetXaxis()->SetRangeUser(15, 150);


    TGraph_FR->Draw("PAE");
    theFit->Draw("SAME");
    std::string outNaming = "results/__fit"  + num+ files + ".png";
//    std::string outNaming = "__fit"  + num+ files + ".root";
...
void testHist() {
    ...
    //#########################
    //Tau Fake Rate
    M_FR(1, "Exp3Par", "debug10GeV.root", "FakeRate_TT_Tau_Pt_After_Loose", "FakeRate_TT_Tau_Pt_Before", Fit_Value_tau, fMin, fMax);
    M_FR(4, "Exp3Par", "debug15GeV.root", "FakeRate_TT_Tau_Pt_After_Loose", "FakeRate_TT_Tau_Pt_Before", Fit_Value_tau, fMin, fMax);

    //#########################
    //CloseJet Fake Rate
    M_FR(11, "Exp3Par", "debug10GeV.root", "FakeRate_TT_Tau_Pt_After_Loose_CloseJet", "FakeRate_TT_Tau_Pt_Before_CloseJet", Fit_Value_tau, fMin, fMax);
    M_FR(14, "Exp3Par", "debug15GeV.root", "FakeRate_TT_Tau_Pt_After_Loose_CloseJet", "FakeRate_TT_Tau_Pt_Before_CloseJet", Fit_Value_tau, fMin, fMax);
