...
#    print Histo_1.GetMaximum()
    ...
    legend_.AddEntry(Histo_1, "Pythia6", "lp")
    legend_.AddEntry(Histo_2, "Pythia8", "lp")
    legend_.Draw()
...
if __name__ == "__main__":
    _PlotMaker("test.root", "SVMass_eeet_pp_NoCorrection", "test.root", "SVMass_eeet_pp", 20)
    _PlotMaker("test.root", "SVMass_mmmt_pp_NoCorrection", "test.root", "SVMass_mmmt_pp", 20)
