...
void  XCheck() {
    ...
    cout<<endl;
    M_FR("Mega2.root", "MMTT_FF_11", "FakeRate_MMTT_apply_ff");
    M_FR("Mega2.root", "MMTT_FP_21", "FakeRate_MMTT_apply_fp");
    M_FR("Mega2.root", "MMTT_PF_31", "FakeRate_MMTT_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "MMET_FF_12", "FakeRate_MMET_apply_ff");
    M_FR("Mega2.root", "MMET_FP_22", "FakeRate_MMET_apply_fp");
    M_FR("Mega2.root", "MMET_PF_32", "FakeRate_MMET_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "MMMT_FF_13", "FakeRate_MMMT_apply_ff");
    M_FR("Mega2.root", "MMMT_FP_23", "FakeRate_MMMT_apply_fp");
    M_FR("Mega2.root", "MMMT_PF_33", "FakeRate_MMMT_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "MMME_FF_14", "FakeRate_MMME_apply_ff");
    M_FR("Mega2.root", "MMME_FP_24", "FakeRate_MMME_apply_fp");
    M_FR("Mega2.root", "MMME_PF_34", "FakeRate_MMME_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "EETT_FF_15", "FakeRate_EETT_apply_ff");
    M_FR("Mega2.root", "EETT_FP_25", "FakeRate_EETT_apply_fp");
    M_FR("Mega2.root", "EETT_PF_35", "FakeRate_EETT_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "EEMT_FF_16", "FakeRate_EEMT_apply_ff");
    M_FR("Mega2.root", "EEMT_FP_26", "FakeRate_EEMT_apply_fp");
    M_FR("Mega2.root", "EEMT_PF_36", "FakeRate_EEMT_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "EEET_FF_17", "FakeRate_EEET_apply_ff");
    M_FR("Mega2.root", "EEET_FP_27", "FakeRate_EEET_apply_fp");
    M_FR("Mega2.root", "EEET_PF_37", "FakeRate_EEET_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "EEEM_FF_18", "FakeRate_EEEM_apply_ff");
    M_FR("Mega2.root", "EEEM_FP_28", "FakeRate_EEEM_apply_fp");
    M_FR("Mega2.root", "EEEM_PF_38", "FakeRate_EEEM_apply_pf");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "ET_Electron_Pt_Before_0", "FakeRate_ET_Electron_Pt_Before_0");
    M_FR("Mega2.root", "ET_Electron_Loose_After_0", "FakeRate_ET_Electron_Loose_After_0");
    M_FR("Mega2.root", "ET_Electron_Tight_After_0", "FakeRate_ET_Electron_Tight_After_0");
    cout<<endl;
    cout<<endl;
    ...
    cout<<endl;
    M_FR("Mega2.root", "MT_Muon_Pt_Before_0", "FakeRate_MT_Muon_Pt_Before_0");
    M_FR("Mega2.root", "MT_Muon_Loose_After_0", "FakeRate_MT_Muon_Loose_After_0");
    M_FR("Mega2.root", "MT_Muon_Tight_After_0", "FakeRate_MT_Muon_Tight_After_0");
    cout<<endl;
    cout<<endl;
