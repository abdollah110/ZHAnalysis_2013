...
void Val3_BGestimation() {
    ...
    if (FRvsJetandEta) {
        ...
        Estim_BG(2, "B", "eleLoose_Jet", "l3_CloseJetPt_", 1, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, Chnl_estimate, Chnl_event);
        Estim_BG(2, "E", "eleLoose_Jet", "l3_CloseJetPt_", 1, "tauLoose_Jet_E", "l4_CloseJetPt_", 1, Chnl_estimate, Chnl_event);
        Estim_BG(3, "B", "muLoose_Jet", "l3_CloseJetPt_", 1, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, Chnl_estimate, Chnl_event);
        Estim_BG(3, "E", "muLoose_Jet", "l3_CloseJetPt_", 1, "tauLoose_Jet_E", "l4_CloseJetPt_", 1, Chnl_estimate, Chnl_event);
        Estim_BG(6, "B", "muLoose_Jet", "l3_CloseJetPt_", 1, "tauLoose_Jet_B", "l4_CloseJetPt_", 1, Chnl_estimate, Chnl_event);
    ...
    PrintResults(Chnl_estimate, Chnl_event, "Newtest.root");
}
