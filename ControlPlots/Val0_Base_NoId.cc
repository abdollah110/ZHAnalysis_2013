...
int main(int argc, char** argv) {
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        //###############################################################################################
        float LT = l3Pt + l4Pt;
        float tmass3 = TMass(met, l3Pt, met * cos(metPhi), l3Px, met * sin(metPhi), l3Py);
        float tmass4 = TMass(met, l4Pt, met * cos(metPhi), l4Px, met * sin(metPhi), l4Py);
        ...
        //###########################        Optimum    #################################################
        //###############################################################################################
        bool tau3_IsoB = l3_tauIsoMVA2raw > 0.5;
        bool tau4_IsoB = l4_tauIsoMVA2raw > 0.5;
        bool tau4_Iso_ltau = l4_tauIsoMVA2raw > 0.5;
        float optimum_Lt_TT = 0;
        float optimum_Lt_MT = 0;
        float optimum_Lt_ET = 0;
        float optimum_Lt_EM = 0;
        float optimum_MT_Isolation = 0.8;
        float optimum_ET_Isolation = 0.8;
        float optimum_EM_Isolation = 0.8;
        //#################################        Loose Cut for Shape      #############################
        float value_looserTauIso = 0.5;
        ...
        if ((Channel == 91) && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            ...
            if (LTcut_tt && charge_Type && tau3_IsoB && tau4_IsoB && (Event != Event_Double[0][1])) {
                ...
                plotFill("TMass3_mmtt_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_mmtt_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            ...
            if (LTcut_tt && SS && l3_tauIsoMVA2raw > value_looserTauIso && l4_tauIsoMVA2raw > value_looserTauIso) {
                ...
                plotFill("TMass3_Shape_mmtt", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_mmtt", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            }
        }
        ...
        if (Channel == 92 && l4Pt > CutOnTauPt && mu_Size == 2 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
            ...
            if (LTcut_et && charge_Type && !tau4_IsoB && (!(l3_eleIso < TightEle)) && (Event != Event_Double[1][2])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][2] = Event;
            }
            if (LTcut_et && charge_Type && !tau4_IsoB && (l3_eleIso < TightEle) && (Event != Event_Double[2][2])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][2] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && (!(l3_eleIso < TightEle)) && (Event != Event_Double[3][2])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][2] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && ((l3_eleIso < TightEle)) && (Event != Event_Double[0][2])) {
                ...
                plotFill("TMass3_mmet_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_mmet_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
            ...
            if (LTcut_et && SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_eleIso < value_looserLepIso)) && (Event != Event_Double[4][2])) {
                ...
                plotFill("TMass3_Shape_mmet", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_mmet", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        ...
        if (Channel == 93 && l4Pt > CutOnTauPt && electron_Size == 0 && l4_tauRejEleL && l4_tauRejMu2T) {
            ...
            if (LTcut_mt && charge_Type && !tau4_IsoB && (!(l3_muIso < TightMu)) && (Event != Event_Double[1][3])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][3] = Event;
            }
            if (LTcut_mt && charge_Type && !tau4_IsoB && (l3_muIso < TightMu) && (Event != Event_Double[2][3])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][3] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && (!(l3_muIso < TightMu)) && (Event != Event_Double[3][3])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][3] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && ((l3_muIso < TightMu)) && (Event != Event_Double[0][3])) {
                ...
                plotFill("TMass3_mmmt_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_mmmt_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
            ...
            if (LTcut_mt && SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_muIso < value_looserLepIso)) && (Event != Event_Double[4][3])) {
                ...
                plotFill("TMass3_Shape_mmmt", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_mmmt", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        ...
        if (Channel == 94) {
            ...
            if (LTcut_em && charge_Type && (!(l4_eleIso < looseLep)) && (!(l3_muIso < looseLep)) && (Event != Event_Double[1][4])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][4] = Event;
            }
            if (LTcut_em && charge_Type && (!(l4_eleIso < looseLep)) && (l3_muIso < looseLep) && (Event != Event_Double[2][4])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][4] = Event;
            }
            if (LTcut_em && charge_Type && ((l4_eleIso < looseLep)) && (!(l3_muIso < looseLep)) && (Event != Event_Double[3][4])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][4] = Event;
            }
            if (LTcut_em && charge_Type && (l4_eleIso < looseLep) && (l3_muIso < looseLep) && (Event != Event_Double[0][4])) {
                ...
                plotFill("TMass3_mmme_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_mmme_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            ...
            if (LTcut_em && SS && ((l4_eleIso < value_looserLepIso)) && ((l3_muIso < value_looserLepIso)) && (Event != Event_Double[4][4])) {
                ...
                plotFill("TMass3_Shape_mmme", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_mmme", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        ...
        if ((Channel == 95) && l3Pt > CutOnTauPt && l4Pt > CutOnTauPt && l3_tauRejMu2L && l3_tauRejEleL && l4_tauRejMu2L && l4_tauRejEleL) {
            ...
            if (LTcut_tt && charge_Type && tau3_IsoB && tau4_IsoB && (Event != Event_Double[0][5])) {
                ...
                plotFill("TMass3_eett_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_eett_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
            ...
            if (LTcut_tt && SS && l3_tauIsoMVA2raw > value_looserTauIso && l4_tauIsoMVA2raw > value_looserTauIso) {
                ...
                plotFill("TMass3_Shape_eett", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_eett", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            }
        }
        //####################################################
        ...
        if (Channel == 96 && l4Pt > CutOnTauPt && electron_Size == 2 && l4_tauRejEleL && l4_tauRejMu2T) {
            ...
            if (LTcut_mt && charge_Type && !tau4_IsoB && (!(l3_muIso < TightMu)) && (Event != Event_Double[1][6])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][6] = Event;
            }
            if (LTcut_mt && charge_Type && !tau4_IsoB && (l3_muIso < TightMu) && (Event != Event_Double[2][6])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][6] = Event;
            }
            if (LTcut_mt && charge_Type && tau4_IsoB && (!(l3_muIso < TightMu)) && (Event != Event_Double[3][6])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][6] = Event;
            }
            //            if (LTcut_mt && charge_Type && tau4_IsoB && (l3_muId_Tight && (l3_muIso < TightMu)) && (Event != Event_Double[0][6]) && mu_Size == 1) {
            if (LTcut_mt && charge_Type && tau4_IsoB && ( (l3_muIso < TightMu)) && (Event != Event_Double[0][6])) {
                plotFill("VisibleMass_lt_pp", VisibleMass, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                ...
                plotFill("TMass3_eemt_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_eemt_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
            ...
            if (LTcut_mt && SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_muIso < value_looserLepIso)) && (Event != Event_Double[4][6])) {
                ...
                plotFill("TMass3_Shape_eemt", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_eemt", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        ...
        if (Channel == 97 && l4Pt > CutOnTauPt && mu_Size == 0 && l4_tauRejEleMVA3T && l4_tauRejMu2L) {
            ...
            if (LTcut_et && charge_Type && !tau4_IsoB && (!(l3_eleIso < TightEle)) && (Event != Event_Double[1][7])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][7] = Event;
            }
            if (LTcut_et && charge_Type && !tau4_IsoB && (l3_eleIso < TightEle) && (Event != Event_Double[2][7])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][7] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && (!(l3_eleIso < TightEle)) && (Event != Event_Double[3][7])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][7] = Event;
            }
            if (LTcut_et && charge_Type && tau4_IsoB && ((l3_eleIso < TightEle)) && (Event != Event_Double[0][7])) {
                ...
                plotFill("TMass3_eeet_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_eeet_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                fillTreeN(BG_Tree, Channel, 3, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
            ...
            if (LTcut_et && SS && l4_tauIsoMVA2raw > value_looserTauIso && ((l3_eleIso < value_looserLepIso)) && (Event != Event_Double[4][7])) {
                ...
                plotFill("TMass3_Shape_eeet", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_eeet", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        ...
        if (Channel == 98) {
            ...
            if (LTcut_em && charge_Type && (!(l3_eleIso < looseLep)) && (!(l4_muIso < looseLep)) && (Event != Event_Double[1][8])) {
                fillTreeN(BG_Tree, Channel, 0, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[1][8] = Event;
            }
            if (LTcut_em && charge_Type && ((l3_eleIso < looseLep)) && (!(l4_muIso < looseLep)) && (Event != Event_Double[2][8])) {
                fillTreeN(BG_Tree, Channel, 1, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[2][8] = Event;
            }
            if (LTcut_em && charge_Type && (!(l3_eleIso < looseLep)) && (l4_muIso < looseLep) && (Event != Event_Double[3][8])) {
                fillTreeN(BG_Tree, Channel, 2, VisibleMass, SVMass, l3Pt, l3Eta, l3_CloseJetPt, l3_CloseJetEta, l4Pt, l4Eta, l4_CloseJetPt, l4_CloseJetEta);
                Event_Double[3][8] = Event;
            }
            if (LTcut_em && charge_Type && (l3_eleIso < looseLep) && (l4_muIso < looseLep) && (Event != Event_Double[0][8])) {
                ...
                plotFill("TMass3_eeem_pp", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_eeem_pp", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            ...
            if (LTcut_em && SS && ((l4_muIso < value_looserLepIso)) && ((l3_eleIso < value_looserLepIso)) && (Event != Event_Double[4][8])) {
                ...
                plotFill("TMass3_Shape_eeem", tmass3, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
                plotFill("TMass4_Shape_eeem", tmass4, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        ...
        if (eleFR_denum_0 && Event != Ev_double_ele) {
            ...
            if (eleFR_denum_0 && l3_eleIso < looseLep) plotFill("4objFR_Ele_NumLoose_0", l3Pt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            if (eleFR_denum_0 && l3_eleIso < TightEle) plotFill("4objFR_Ele_NumTight_0", l3Pt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            if (eleFR_denum_0 && l3_eleIso < looseLep) plotFill("4objFR_Ele_NumLoose_0_Jet", l3_CloseJetPt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            if (eleFR_denum_0 && l3_eleIso < TightEle) plotFill("4objFR_Ele_NumTight_0_Jet", l3_CloseJetPt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        }
        ...
        if (muFR_denum_0 && Event != Ev_double_mu) {
            ...
            if (muFR_denum_0 && l3_muIso < looseLep) plotFill("4objFR_Mu_NumLoose_0", l3Pt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            if (muFR_denum_0 && l3_muIso < TightMu) plotFill("4objFR_Mu_NumTight_0", l3Pt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            if (muFR_denum_0 && l3_muIso < looseLep) plotFill("4objFR_Mu_NumLoose_0_Jet", l3_CloseJetPt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
            if (muFR_denum_0 && l3_muIso < TightMu) plotFill("4objFR_Mu_NumTight_0_Jet", l3_CloseJetPt, pt_Bin, 0, pt_Bin, pu_Weight * eff_Correction);
        }
        //
        //
        //        //##################################################
