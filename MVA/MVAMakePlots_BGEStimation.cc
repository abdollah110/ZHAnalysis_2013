...
int main(int argc, char** argv) {
    ...
    for (Int_t i = 0; i < nentries_wtn; i++) {
        ...
        bool ElectronIso = (l3_eleIso < .5);
        bool MuonIso = (l3_muIso < .5);
        bool CheckHSign;
        ...
        if ((Channel == 91) && CheckHSign && l3Pt > Val_tauPt && l4Pt > Val_tauPt) {
        ...
        //        if (Channel == 92 && CheckHSign&& l4Pt > Val_tauPt && mu_Size == 2 && l4_tauIsoMVA2raw > 0 && l3_eleIso < 1) {
        if (Channel == 92 && CheckHSign && l4Pt > Val_tauPt && mu_Size == 2) {
            ...
            //            if (!l4tauIso && (!ElectronIso) && (Event != Event_Double[1][2]) && ((electron_Size - ele_partTight_Size == 0))) {
            if (!l4tauIso && (!ElectronIso) && (Event != Event_Double[1][2])) {
                plotFill("FakeRate_MMET_apply_ff", l4Pt, l3Pt, pt_Bin, 0, pt_Bin, pt_Bin, 0, pt_Bin);
                Event_Double[1][2] = Event;
            }
            //            if (!l4tauIso && (ElectronIso) && (Event != Event_Double[2][2]) && electron_Size == 1) {
            if (!l4tauIso && (ElectronIso) && (Event != Event_Double[2][2])) {
                plotFill("FakeRate_MMET_apply_fp", l4Pt, pt_Bin, 0, pt_Bin);
                Event_Double[2][2] = Event;
            }
            //            if (l4tauIso && (!ElectronIso) && (Event != Event_Double[3][2]) && ((electron_Size - ele_partTight_Size == 0))) {
            if (l4tauIso && (!ElectronIso) && (Event != Event_Double[3][2])) {
                plotFill("FakeRate_MMET_apply_pf", l3Pt, pt_Bin, 0, pt_Bin);
                Event_Double[3][2] = Event;
            }
            if (l4tauIso && (l3_eleId && (l3_eleIso < 0.1)) && (Event != Event_Double[0][2]) && ((electron_Size == 1))) {
        ...
        //        if (Channel == 93 && CheckHSign && l4Pt > Val_tauPt && electron_Size == 0 && l4_tauIsoMVA2raw > 0 && l3_muIso < 1) {
        if (Channel == 93 && CheckHSign && l4Pt > Val_tauPt && electron_Size == 0) {
            ...
            //            if (!l4tauIso && (!MuonIso) && (Event != Event_Double[1][3]) && (mu_Size - mu_partTight_Size == 2)) {
            if (!l4tauIso && (!MuonIso) && (Event != Event_Double[1][3])) {
                plotFill("FakeRate_MMMT_apply_ff", l4Pt, l3Pt, pt_Bin, 0, pt_Bin, pt_Bin, 0, pt_Bin);
                Event_Double[1][3] = Event;
            }
            //            if (!l4tauIso && (MuonIso) && (Event != Event_Double[2][3]) && mu_Size == 3) {
            if (!l4tauIso && (MuonIso) && (Event != Event_Double[2][3])) {
                plotFill("FakeRate_MMMT_apply_fp", l4Pt, pt_Bin, 0, pt_Bin);
                Event_Double[2][3] = Event;
            }
            //            if (l4tauIso && (!MuonIso) && (Event != Event_Double[3][3]) && (mu_Size - mu_partTight_Size == 2)) {
            if (l4tauIso && (!MuonIso) && (Event != Event_Double[3][3])) {
                plotFill("FakeRate_MMMT_apply_pf", l3Pt, pt_Bin, 0, pt_Bin);
                Event_Double[3][3] = Event;
            }
            if (l4tauIso && (MuonIso) && (Event != Event_Double[0][3]) && (mu_Size == 3)) {
                plotFill("TMass_lepMet", TMass_lepMet, pt_Bin, 0, pt_Bin);
        ...
        if ((Channel == 95) && CheckHSign && l3Pt > Val_tauPt && l4Pt > Val_tauPt ) {
        ...
        //        if (Channel == 96 && CheckHSign && l4Pt > Val_tauPt && electron_Size == 2 && l4_tauIsoMVA2raw > 0 && l3_muIso < 1) {
        if (Channel == 96 && CheckHSign && l4Pt > Val_tauPt && electron_Size == 2) {
            ...
            //            if (!l4_tauIsoM && (!MuonIso) && (Event != Event_Double[1][6]) && (mu_Size - mu_partTight_Size == 0)) {
            if (!l4tauIso && (!MuonIso) && (Event != Event_Double[1][6])) {
                plotFill("FakeRate_EEMT_apply_ff", l4Pt, l3Pt, pt_Bin, 0, pt_Bin, pt_Bin, 0, pt_Bin);
                Event_Double[1][6] = Event;
            }
            //            if (!l4_tauIsoM && (MuonIso) && (Event != Event_Double[2][6]) && mu_Size == 1) {
            if (!l4tauIso && (MuonIso) && (Event != Event_Double[2][6])) {
                plotFill("FakeRate_EEMT_apply_fp", l4Pt, pt_Bin, 0, pt_Bin);
                Event_Double[2][6] = Event;
            }
            //            if (l4_tauIsoM && (!MuonIso) && (Event != Event_Double[3][6]) && (mu_Size - mu_partTight_Size == 0)) {
            if (l4tauIso && (!MuonIso) && (Event != Event_Double[3][6])) {
                plotFill("FakeRate_EEMT_apply_pf", l3Pt, pt_Bin, 0, pt_Bin);
                Event_Double[3][6] = Event;
            }
            if (l4tauIso && (MuonIso) && (Event != Event_Double[0][6]) && (mu_Size == 1)) {
                plotFill("TMass_lepMet", TMass_lepMet, pt_Bin, 0, pt_Bin);
        ...
        //        if (Channel == 97 && CheckHSign && l4Pt > Val_tauPt && mu_Size == 0 && l4_tauIsoMVA2raw > 0 && l3_eleIso < 1) {
        if (Channel == 97 && CheckHSign && l4Pt > Val_tauPt && mu_Size == 0) {
            ...
            //            if (!l4tauIso && (!ElectronIso) && (Event != Event_Double[1][7]) && (electron_Size - ele_partTight_Size == 2)) {
            if (!l4tauIso && (!ElectronIso) && (Event != Event_Double[1][7])) {
                plotFill("FakeRate_EEET_apply_ff", l4Pt, l3Pt, pt_Bin, 0, pt_Bin, pt_Bin, 0, pt_Bin);
                Event_Double[1][7] = Event;
            }
            //            if (!l4tauIso && (ElectronIso) && (Event != Event_Double[2][7]) && electron_Size == 3) {
            if (!l4tauIso && (ElectronIso) && (Event != Event_Double[2][7])) {
                plotFill("FakeRate_EEET_apply_fp", l4Pt, pt_Bin, 0, pt_Bin);
                Event_Double[2][7] = Event;
            }
            //            if (l4tauIso && (!ElectronIso) && (Event != Event_Double[3][7]) && (electron_Size - ele_partTight_Size == 2)) {
            if (l4tauIso && (!ElectronIso) && (Event != Event_Double[3][7])) {
                plotFill("FakeRate_EEET_apply_pf", l3Pt, pt_Bin, 0, pt_Bin);
                Event_Double[3][7] = Event;
            }
            if (l4tauIso && (ElectronIso) && (Event != Event_Double[0][7]) && (electron_Size == 3)) {
                plotFill("TMass_lepMet", TMass_lepMet, pt_Bin, 0, pt_Bin);
        ...
        if (eleFR_denum_0 && ElectronIso) plotFill("4objFR_Ele_NumLoose_0", l3Pt, pt_Bin, 0, pt_Bin);
        if (eleFR_denum_0 && ElectronIso) plotFill("4objFR_Ele_NumTight_0", l3Pt, pt_Bin, 0, pt_Bin);
        ...
        if (muFR_denum_0 && MuonIso) plotFill("4objFR_Mu_NumLoose_0", l3Pt, pt_Bin, 0, pt_Bin);
        if (muFR_denum_0 && MuonIso) plotFill("4objFR_Mu_NumTight_0", l3Pt, pt_Bin, 0, pt_Bin);
