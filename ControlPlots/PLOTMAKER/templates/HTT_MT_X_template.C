...
static const float SIGNAL_SCALE = 5.;
...
*/
{
  switch(idx){
  case 1: // ZZ
std::cout << "scaling by 1 ZZ" << std::endl;hin->Scale(1);
break;
  case 2: // GGToZZ2L2L
std::cout << "scaling by 1 GGToZZ2L2L" << std::endl;hin->Scale(1);
break;
  case 3: // Zjets
std::cout << "scaling by 1 Zjets" << std::endl;hin->Scale(1);
hin->SetBinError(1,hin->GetBinContent(1)*0.44);
hin->SetBinError(2,hin->GetBinContent(2)*0.44);
hin->SetBinError(3,hin->GetBinContent(3)*0.44);
hin->SetBinError(4,hin->GetBinContent(4)*0.44);
hin->SetBinError(5,hin->GetBinContent(5)*0.44);
hin->SetBinError(6,hin->GetBinContent(6)*0.44);
hin->SetBinError(7,hin->GetBinContent(7)*0.44);
hin->SetBinError(8,hin->GetBinContent(8)*0.44);
hin->SetBinError(9,hin->GetBinContent(9)*0.44);
hin->SetBinError(10,hin->GetBinContent(10)*0.44);
hin->SetBinError(11,hin->GetBinContent(11)*0.44);
hin->SetBinError(12,hin->GetBinContent(12)*0.44);
hin->SetBinError(13,hin->GetBinContent(13)*0.44);
hin->SetBinError(14,hin->GetBinContent(14)*0.44);
hin->SetBinError(15,hin->GetBinContent(15)*0.44);

break;
//#ifndef DROP_SIGNAL
  case 4: // ZH_htt
std::cout << "scaling by 1 ZH_htt" << std::endl;hin->Scale(1);
break;
  case 5: // ZH_hww
std::cout << "scaling by 1 ZH_hww" << std::endl;hin->Scale(1);
break;
//#endif
  default :
...
void 
HTT_MT_X(bool scaled=true, bool log=false, float min=0., float max=-1., const char* inputfile="root/$HISTFILE", const char* directory="$CATEGORY")
{
  ...
  const char* dataset;
  if(std::string(inputfile).find("7TeV")!=std::string::npos){dataset = "CMS Preliminary,  ZH#rightarrowll#tau#tau, 4.9 fb^{-1} at 7 TeV";}
...
//  //CMSPrelim(dataset, "#tau_{e}#tau_{#mu}", 0.17, 0.835);  
  ...
  chan->SetTextColor(    1 );
  chan->SetTextFont (   62 );
  if (directory=="eemt_zh")
    chan->AddText("ee#mu#tau");
  else 
    chan->AddText("#mu#mu#mu#tau");
  chan->Draw();
//
