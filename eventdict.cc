//
// File generated by rootcint at Wed Feb 20 19:01:49 2013
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::myevent*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("myevent", ::myevent::Class_Version(), "./interface/myevent.h", 10,
...
void myobject::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "againstElectronTightMVA2", &againstElectronTightMVA2);
...
void myevent::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.InspectMember("vector<myobject>", (void*)&RecGenParticle, "RecGenParticle.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "RecGenMet", (void*)&RecGenMet);
      R__insp.InspectMember("vector<myobject>", (void*)&RecGenMet, "RecGenMet.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "RecGenJet", (void*)&RecGenJet);
      R__insp.InspectMember("vector<myobject>", (void*)&RecGenJet, "RecGenJet.", false);
...
static int G__eventdict_447_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<myobject,allocator<myobject> >::reverse_iterator* pobj;
...
static int G__eventdict_447_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 107, (long) ((const vector<myobject,allocator<myobject> >*) G__getstructoffset())->size());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__eventdict_447_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<myobject,allocator<myobject> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__eventdict_447_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   vector<myobject,allocator<myobject> >* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
...
static int G__eventdict_447_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__eventdict_447_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__eventdict_447_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__eventdict_447_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<myobject,allocator<myobject> >::iterator* pobj;
...
static int G__eventdict_447_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__eventdict_447_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
static void G__setup_memvarmyobject(void) {
   ...
   G__memvar_setup((void*)((long)(&p->position_Rho)-(long)(p)),100,0,0,-1,-1,-1,1,"position_Rho=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->position_rho)-(long)(p)),100,0,0,-1,-1,-1,1,"position_rho=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)((long)(&p->dxy_in)-(long)(p)),100,0,0,-1,-1,-1,1,"dxy_in=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->dZ_in)-(long)(p)),100,0,0,-1,-1,-1,1,"dZ_in=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)((long)(&p->discriminationByDecayModeFinding)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByDecayModeFinding=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByVeryLooseIsolation)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByVeryLooseIsolation=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByLooseIsolation)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByLooseIsolation=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByMediumIsolation)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByMediumIsolation=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByTightIsolation)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByTightIsolation=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByElectronLoose)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByElectronLoose=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByElectronMedium)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByElectronMedium=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByElectronTight)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByElectronTight=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByElectronMVA)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByElectronMVA=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByMuonLoose)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByMuonLoose=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByMuonMedium)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByMuonMedium=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->discriminationByMuonTight)-(long)(p)),102,0,0,-1,-1,-1,1,"discriminationByMuonTight=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byVLooseCombinedIsolationDeltaBetaCorr)-(long)(p)),102,0,0,-1,-1,-1,1,"byVLooseCombinedIsolationDeltaBetaCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byLooseCombinedIsolationDeltaBetaCorr)-(long)(p)),102,0,0,-1,-1,-1,1,"byLooseCombinedIsolationDeltaBetaCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byMediumCombinedIsolationDeltaBetaCorr)-(long)(p)),102,0,0,-1,-1,-1,1,"byMediumCombinedIsolationDeltaBetaCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byTightCombinedIsolationDeltaBetaCorr)-(long)(p)),102,0,0,-1,-1,-1,1,"byTightCombinedIsolationDeltaBetaCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byIsolationMVAraw)-(long)(p)),102,0,0,-1,-1,-1,1,"byIsolationMVAraw=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byLooseIsolationMVA)-(long)(p)),102,0,0,-1,-1,-1,1,"byLooseIsolationMVA=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byMediumIsolationMVA)-(long)(p)),102,0,0,-1,-1,-1,1,"byMediumIsolationMVA=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->byTightIsolationMVA)-(long)(p)),102,0,0,-1,-1,-1,1,"byTightIsolationMVA=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->againstElectronTightMVA2)-(long)(p)),102,0,0,-1,-1,-1,1,"againstElectronTightMVA2=",0,(char*)NULL);
...
static void G__setup_memvarmyevent(void) {
   ...
   G__memvar_setup((void*)((long)(&p->RecGenParticle)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR),G__defined_typename("vector<myobject>"),-1,1,"RecGenParticle=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->RecGenMet)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR),G__defined_typename("vector<myobject>"),-1,1,"RecGenMet=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->RecGenJet)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR),G__defined_typename("vector<myobject>"),-1,1,"RecGenJet=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)((long)(&p->RhoCorr)-(long)(p)),100,0,0,-1,-1,-1,1,"RhoCorr=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->RhoCenNeutral)-(long)(p)),100,0,0,-1,-1,-1,1,"RhoCenNeutral=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->RhoCenCharged)-(long)(p)),100,0,0,-1,-1,-1,1,"RhoCenCharged=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->RhoCenNeutralTight)-(long)(p)),100,0,0,-1,-1,-1,1,"RhoCenNeutralTight=",0,(char*)NULL);
...
static void G__setup_memfuncmyobject(void) {
   ...
   G__memfunc_setup("myobject",861,G__eventdict_444_0_1, 105, G__get_linked_tagnum(&G__eventdictLN_myobject), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__eventdict_444_0_2, 85, G__get_linked_tagnum(&G__eventdictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&myobject::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__eventdict_444_0_3, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&myobject::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__eventdict_444_0_4, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&myobject::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__eventdict_444_0_5, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&myobject::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__eventdict_444_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__eventdict_444_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&myobject::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__eventdict_444_0_11, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&myobject::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__eventdict_444_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&myobject::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__eventdict_444_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&myobject::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("myobject", 861, G__eventdict_444_0_14, (int) ('i'), G__get_linked_tagnum(&G__eventdictLN_myobject), -1, 0, 1, 1, 1, 0, "u 'myobject' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~myobject", 987, G__eventdict_444_0_15, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__eventdict_444_0_16, (int) ('u'), G__get_linked_tagnum(&G__eventdictLN_myobject), -1, 1, 1, 1, 1, 0, "u 'myobject' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
static void G__setup_memfuncmyevent(void) {
   ...
   G__memfunc_setup("myevent",776,G__eventdict_445_0_1, 105, G__get_linked_tagnum(&G__eventdictLN_myevent), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__eventdict_445_0_2, 85, G__get_linked_tagnum(&G__eventdictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&myevent::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__eventdict_445_0_3, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&myevent::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__eventdict_445_0_4, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&myevent::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__eventdict_445_0_5, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&myevent::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__eventdictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - insp", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__eventdict_445_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__eventdict_445_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&myevent::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__eventdict_445_0_11, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&myevent::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__eventdict_445_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&myevent::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__eventdict_445_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&myevent::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("myevent", 776, G__eventdict_445_0_14, (int) ('i'), G__get_linked_tagnum(&G__eventdictLN_myevent), -1, 0, 1, 1, 1, 0, "u 'myevent' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~myevent", 902, G__eventdict_445_0_15, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__eventdict_445_0_16, (int) ('u'), G__get_linked_tagnum(&G__eventdictLN_myevent), -1, 1, 1, 1, 1, 0, "u 'myevent' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEmyobjectcOallocatorlEmyobjectgRsPgR(void) {
   ...
   G__memfunc_setup("at",213,G__eventdict_447_0_1, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<myobject,allocator<myobject> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__eventdict_447_0_2, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<myobject,allocator<myobject> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("begin",517,G__eventdict_447_0_3, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("end",311,G__eventdict_447_0_4, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rbegin",631,G__eventdict_447_0_5, 117, G__get_linked_tagnum(&G__eventdictLN_reverse_iteratorlEvectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiteratorgR), G__defined_typename("vector<myobject,allocator<myobject> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("rend",425,G__eventdict_447_0_6, 117, G__get_linked_tagnum(&G__eventdictLN_reverse_iteratorlEvectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiteratorgR), G__defined_typename("vector<myobject,allocator<myobject> >::reverse_iterator"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__eventdict_447_0_7, 107, -1, G__defined_typename("vector<myobject,allocator<myobject> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("max_size",864,G__eventdict_447_0_8, 107, -1, G__defined_typename("vector<myobject,allocator<myobject> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__eventdict_447_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<myobject,allocator<myobject> >::size_type' 0 - sz", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("resize",658,G__eventdict_447_0_10, 121, -1, -1, 0, 2, 1, 1, 0, 
"k - 'vector<myobject,allocator<myobject> >::size_type' 0 - sz u 'myobject' - 0 - c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("capacity",846,G__eventdict_447_0_11, 107, -1, G__defined_typename("vector<myobject,allocator<myobject> >::size_type"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("empty",559,G__eventdict_447_0_12, 103, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__eventdict_447_0_13, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::reference"), 1, 1, 1, 1, 0, "k - 'vector<myobject,allocator<myobject> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__eventdict_447_0_14, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::const_reference"), 1, 1, 1, 1, 8, "k - 'vector<myobject,allocator<myobject> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<myobject,allocator<myobject> >",3662,G__eventdict_447_0_15, 105, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<myobject,allocator<myobject> >",3662,G__eventdict_447_0_16, 105, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR), -1, 0, 2, 1, 1, 0, 
"k - 'vector<myobject,allocator<myobject> >::size_type' 0 - n u 'myobject' - 11 'myobject()' value", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<myobject,allocator<myobject> >",3662,G__eventdict_447_0_17, 105, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR), -1, 0, 1, 1, 1, 0, "u 'vector<myobject,allocator<myobject> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("vector<myobject,allocator<myobject> >",3662,G__eventdict_447_0_18, 105, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR), -1, 0, 2, 1, 1, 0, 
"u 'vector<myobject,allocator<myobject> >::iterator' 'vector<myobject,allocator<myobject> >::const_iterator' 10 - first u 'vector<myobject,allocator<myobject> >::iterator' 'vector<myobject,allocator<myobject> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__eventdict_447_0_19, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgR), -1, 1, 1, 1, 1, 0, "u 'vector<myobject,allocator<myobject> >' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("reserve",764,G__eventdict_447_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "k - 'vector<myobject,allocator<myobject> >::size_type' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("front",553,G__eventdict_447_0_21, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("back",401,G__eventdict_447_0_22, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__eventdict_447_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "u 'myobject' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("swap",443,G__eventdict_447_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<myobject,allocator<myobject> >' - 1 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__eventdict_447_0_25, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 2, 1, 1, 0, 
"u 'vector<myobject,allocator<myobject> >::iterator' - 0 - position u 'myobject' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__eventdict_447_0_26, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'vector<myobject,allocator<myobject> >::iterator' 'vector<myobject,allocator<myobject> >::const_iterator' 10 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("insert",661,G__eventdict_447_0_27, 121, -1, -1, 0, 3, 1, 1, 0, 
...
"u 'myobject' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("pop_back",831,G__eventdict_447_0_28, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__eventdict_447_0_29, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<myobject,allocator<myobject> >::iterator' - 0 - position", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("erase",528,G__eventdict_447_0_30, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'vector<myobject,allocator<myobject> >::iterator' - 0 - first u 'vector<myobject,allocator<myobject> >::iterator' - 0 - last", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("clear",519,G__eventdict_447_0_31, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~vector<myobject,allocator<myobject> >", 3788, G__eventdict_447_0_32, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncvectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator(void) {
   ...
   G__memfunc_setup("iterator",874,G__eventdict_448_0_1, 105, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("iterator",874,G__eventdict_448_0_2, 105, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 5, 1, 0, "U 'myobject' 'vector<myobject,allocator<myobject> >::iterator::pointer' 11 - __i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator*",918,G__eventdict_448_0_3, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::iterator::reference"), 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator->",983,G__eventdict_448_0_4, 85, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::iterator::pointer"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator++",962,G__eventdict_448_0_5, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator++",962,G__eventdict_448_0_6, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 1, 1, 0, "i - - 0 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator--",966,G__eventdict_448_0_7, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 1, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator--",966,G__eventdict_448_0_8, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 1, 1, 0, "i - - 0 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator[]",1060,G__eventdict_448_0_9, 117, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::iterator::reference"), 1, 1, 1, 1, 8, "l - 'vector<myobject,allocator<myobject> >::iterator::difference_type' 11 - __n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator+=",980,G__eventdict_448_0_10, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 1, 1, 1, 1, 0, "l - 'vector<myobject,allocator<myobject> >::iterator::difference_type' 11 - __n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator+",919,G__eventdict_448_0_11, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 1, 1, 8, "l - 'vector<myobject,allocator<myobject> >::iterator::difference_type' 11 - __n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator-=",982,G__eventdict_448_0_12, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 1, 1, 1, 1, 0, "l - 'vector<myobject,allocator<myobject> >::iterator::difference_type' 11 - __n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator-",921,G__eventdict_448_0_13, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 1, 1, 8, "l - 'vector<myobject,allocator<myobject> >::iterator::difference_type' 11 - __n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("base",411,G__eventdict_448_0_14, 85, G__get_linked_tagnum(&G__eventdictLN_myobject), G__defined_typename("vector<myobject,allocator<myobject> >::iterator::pointer"), 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__eventdict_448_0_15, 117, G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 1, 1, 0, "u 'vector<myobject,allocator<myobject> >::iterator' - 11 - x", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("iterator", 874, G__eventdict_448_0_16, (int) ('i'), G__get_linked_tagnum(&G__eventdictLN_vectorlEmyobjectcOallocatorlEmyobjectgRsPgRcLcLiterator), -1, 0, 1, 1, 1, 0, "u 'vector<myobject,allocator<myobject> >::iterator' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~iterator", 1000, G__eventdict_448_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
