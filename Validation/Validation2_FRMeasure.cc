...
void Validation2_FRMeasure() {

    TFile *FR_File = new TFile("FitValues_FR.root", "RECREATE");

    TH2F * Fit_Value_tau = new TH2F("Fit_Value_tau", "Fit_Value_tau", 30, 0, 30, 30, 0, 30);
    ...
    M_FR(11, "Exp3Par", "valid_Mega.root", "FakeRate_TT_Tau_Pt_After_Loose_Jet", "FakeRate_TT_Tau_Pt_Before_Jet", Fit_Value_tau, fMin, fMax);
    ...
    //    M_FR(14, "Exp3Par", "valid_Mega.root", "FakeRate_TT_Tau_Pt_After_Loose_B", "FakeRate_TT_Tau_Pt_Before_B", Fit_Value_tau, fMin, fMax);
    ...
    //    M_FR(17, "Exp3Par", "valid_Mega.root", "FakeRate_TT_Tau_Pt_After_Loose_E", "FakeRate_TT_Tau_Pt_Before_E", Fit_Value_tau, fMin, fMax);
    ...
    //    M_FR(24, "Exp3Par", "valid_Mega.root", "FakeRate_TT_Tau_Pt_After_Loose_B", "FakeRate_TT_Tau_Pt_Before_B", Fit_Value_tau, fMin, fMax);
    ...
    //    M_FR(27, "Exp3Par", "valid_Mega.root", "FakeRate_TT_Tau_Pt_After_Loose_E", "FakeRate_TT_Tau_Pt_Before_E", Fit_Value_tau, fMin, fMax);
